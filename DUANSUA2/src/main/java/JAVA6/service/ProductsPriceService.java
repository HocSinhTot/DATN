...
public class ProductsPriceService {
    ...
    public ProductsPriceModel updateProductsPrice(ProductsPriceId id, ProductsPriceModel updatedProductsPrice) {
    ...
    // Xóa ProductsPrice
    public void deleteProductsPrice(ProductsPriceId id) {
